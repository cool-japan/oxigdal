...
fn test_azure_config_creation() {
    use oxigdal_cloud_enhanced::azure;
...
fn test_gcp_config_creation() {
    use oxigdal_cloud_enhanced::gcp;
...
fn test_azure_data_lake_types() {
    use oxigdal_cloud_enhanced::azure::data_lake::{AclScope, AclType};
...
// (crates/oxigdal-cloud-enhanced/src/gcp/mod.rs) and `gcp::cost::CostClient`,
