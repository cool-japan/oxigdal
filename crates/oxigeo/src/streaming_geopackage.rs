...
/// the given table.
fn gpkg_geometry_column_name(gpkg: &oxigeo_gpkg::GeoPackage, table_name: &str) -> Option<String> {
...
/// when parsing fails.
fn column_names_from_master(gpkg: &oxigeo_gpkg::GeoPackage, table_name: &str) -> Vec<String> {
