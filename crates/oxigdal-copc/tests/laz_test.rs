...
use oxigdal_copc::error::CopcError;
use oxigdal_copc::laz::{
...
use oxigdal_copc::copc_vlr::{Vlr, VlrKey};
...
fn test_arithmetic_decode_uniform_bits_round_trip() {
    ...
    // touch the crate-internal module through `oxigdal_copc::laz::arithmetic`.
    use oxigdal_copc::laz::arithmetic::{ArithmeticDecoder, ArithmeticEncoder};
...
fn test_arithmetic_symbol_model_2_symbol_round_trip() {
    use oxigdal_copc::laz::arithmetic::{ArithmeticDecoder, ArithmeticEncoder, SymbolModel};
...
fn test_chunk_table_parse_minimal_two_chunks() {
    use oxigdal_copc::laz::chunk_table::parse_chunk_table;
...
fn test_predictor_xyz_v1_recovers_constant_stream() {
    use oxigdal_copc::laz::arithmetic::{ArithmeticDecoder, ArithmeticEncoder, IntegerCompressor};
    use oxigdal_copc::laz::predictors::{PointXYZContext, decode_xyz_v1, encode_xyz_v1};
...
fn test_predictor_intensity_v1_recovers_repeated_values() {
    use oxigdal_copc::laz::arithmetic::{ArithmeticDecoder, ArithmeticEncoder, SymbolModel};
    use oxigdal_copc::laz::predictors::{decode_intensity_v1, encode_intensity_v1};
...
fn test_predictor_classification_v1_256_contexts_independent() {
    use oxigdal_copc::laz::arithmetic::{ArithmeticDecoder, ArithmeticEncoder};
    use oxigdal_copc::laz::predictors::{
...
fn test_decompress_format_0_5_points_round_trip() {
    use oxigdal_copc::laz::format_v1::{PF0_RECORD_SIZE, compress_format_0, decompress_format_0};
...
fn test_decompress_format_1_includes_gps_time() {
    use oxigdal_copc::laz::format_v1::{PF1_RECORD_SIZE, compress_format_1, decompress_format_1};
    let mut records = Vec::new();
...
fn build_copc_with_laz(
    ...
    if with_laszip_vlr {
        use oxigdal_copc::laz::format_v1::{compress_format_0, compress_format_1};
