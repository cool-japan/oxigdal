...
//! `oxigdal-ml` crate's raster-native pre/post-processing utilities:
...
use oxigdal_ml::classification::classify_single_label;
use oxigdal_ml::detection::{
    BoundingBox as MlBoundingBox, Detection, NmsConfig, non_maximum_suppression,
};
use oxigdal_ml::preprocessing::{NormalizationParams, normalize, resize_nearest};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\nKey Points:");
    println!("  - `oxigdal-ml` provides raster-native pre/post-processing helpers");
