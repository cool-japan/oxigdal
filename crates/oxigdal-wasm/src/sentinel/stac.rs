...
//!
//! Builds `oxigdal-stac` `SearchRequest`s, POSTs them to Earth Search v1
...
use oxigdal_stac::chrono::{NaiveDate, TimeDelta};
use oxigdal_stac::client::{SearchRequest, StacItem};

#[cfg(target_arch = "wasm32")]
use oxigdal_stac::client::{ItemCollection, StacApiClient};
#[cfg(target_arch = "wasm32")]
...
mod tests {
    use super::*;
    use oxigdal_stac::client::StacApiClient;
