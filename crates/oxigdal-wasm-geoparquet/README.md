...
Part of [OxiGDAL](https://github.com/cool-japan/oxigdal), the Pure-Rust
...
```bash
wasm-pack build crates/oxigdal-wasm-geoparquet --target web --release
```
