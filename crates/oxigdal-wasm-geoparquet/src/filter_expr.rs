...
//! `oxigdal-geoparquet` [`AttributeFilter`]s: AND chains flatten, `=`
...
//!   compiler in `oxigdal-geoparquet` currently evaluates only
...
use oxigdal_geoparquet::{AttributeFilter, CmpOp, ScalarValue};
