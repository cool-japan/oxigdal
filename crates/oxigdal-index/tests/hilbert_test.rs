...
use oxigdal_index::rtree::hilbert::compute_hilbert_value as compute_hilbert_value_direct;
use oxigdal_index::{Bbox2D, HilbertRTree, RTree, compute_hilbert_value};
