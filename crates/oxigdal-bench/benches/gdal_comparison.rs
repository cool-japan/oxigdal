...
use oxigdal_algorithms::simd::raster::{add_f32, mul_f32, sub_f32};
...
fn bench_output_path(name: &str) -> PathBuf {
    ...
    path.push("oxigdal_bench_gdal_comparison");
...
fn bench_io_throughput_vs_gdal(c: &mut Criterion) {
    ...
    for size in [512u32, 1024, 2048].iter() {
        ...
        group.bench_with_input(BenchmarkId::new("oxigdal_write", size), size, |b, &sz| {
            b.iter(|| {
...
fn bench_compression_vs_gdal(c: &mut Criterion) {
    ...
    #[cfg(feature = "deflate")]
    group.bench_with_input(BenchmarkId::new("oxigdal", "deflate"), &data, |b, data| {
        b.iter(|| {
    ...
    #[cfg(feature = "lzw")]
    group.bench_with_input(BenchmarkId::new("oxigdal", "lzw"), &data, |b, data| {
        b.iter(|| {
    ...
    #[cfg(feature = "zstd")]
    group.bench_with_input(BenchmarkId::new("oxigdal", "zstd"), &data, |b, data| {
        b.iter(|| {
