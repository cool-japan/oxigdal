...
> **Purpose:** Apache Kafka integration for OxiGeo — async producer/consumer with schema registry and transactions.
...
- **Blocks:** oxigeo-streaming (durable sink), oxigeo-services (event push)
