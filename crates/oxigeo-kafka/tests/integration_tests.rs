//! Integration tests for oxigeo-kafka
//!
...
use oxigeo_kafka::config::{Acks, CompressionType, IsolationLevel, OffsetReset};
use oxigeo_kafka::consumer::{CommitStrategy, ConsumerConfig, KafkaConsumer};
use oxigeo_kafka::producer::{KafkaProducer, ProducerConfig};
