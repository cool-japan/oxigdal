...
[dependencies]
# Filesystem support
oxigeo-zarr = { version = "0.2.0", features = ["filesystem"] }

# Cloud storage with S3
oxigeo-zarr = { version = "0.2.0", features = ["s3", "async"] }

# HTTP remote access
oxigeo-zarr = { version = "0.2.0", features = ["http"] }

# Compression codecs
oxigeo-zarr = { version = "0.2.0", features = ["zstd", "gzip", "lz4"] }

# Parallel processing
oxigeo-zarr = { version = "0.2.0", features = ["parallel"] }

# Chunk caching
oxigeo-zarr = { version = "0.2.0", features = ["cache"] }

# All features
oxigeo-zarr = { version = "0.2.0", features = ["filesystem", "s3", "http", "async", "zstd", "gzip", "lz4", "shuffle", "delta", "scale-offset", "parallel", "cache", "v2", "v3"] }
```
