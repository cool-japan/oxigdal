//! Independently verify an OxiGDAL session attestation from the command line.
//!
...
//!
//! ```text
//! cargo run -p oxigdal-security --features attestation \
...
use oxigdal_security::attestation::verify_attestation;
