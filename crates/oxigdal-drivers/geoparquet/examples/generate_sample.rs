...
//!
//! ```text
//! cargo run -p oxigdal-geoparquet --example generate_sample --features snappy
//! ```
//!
...
mod generator {
    ...
    use oxigdal_geoparquet::geometry::{Coordinate, Geometry, LineString, Polygon, WkbWriter};
