...
//! file via `oxih5`'s writer. The old custom `OXIGDAL_HDF5_METADATA_V1` JSON
//! sidecar writer has been retired.
//!
...
mod tests {
    ...
    fn test_finalize_emits_real_hdf5() {
        ...
        let path = dir.join("oxigdal_hdf5_writer_real_signature.h5");
    ...
    fn test_unsupported_root_attr_fails_loud() {
        let dir = std::env::temp_dir();
        let path = dir.join("oxigdal_hdf5_writer_unsupported_root_attr.h5");
