...
//!
//! These tests exercise the public API exposed from `oxigdal_hdf5::superblock_v2`
//! and verify end-to-end dispatch via `Hdf5Reader::open`.

use oxigdal_hdf5::superblock_v2::{
...
fn test_superblock_v2_reader_dispatch_no_longer_errors_with_hdf5_sys_stub() {
    ...
    let tmp = std::env::temp_dir().join("oxigdal_test_hdf5_v2_superblock_dispatch.h5");
